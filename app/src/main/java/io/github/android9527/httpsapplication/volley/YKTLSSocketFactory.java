...
public class YKTLSSocketFactory extends SSLSocketFactory {
    ...
    public YKTLSSocketFactory(Context context) {
        try {
            internalSSLSocketFactory = getSslSocketFactory(context);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static SSLSocketFactory getSslSocketFactory(Context context) {
        try {
            TrustManager[] trustManagers = new TrustManager[]{getTrustManagers(context)};
    ...
    public static X509TrustManager getTrustManagers(Context context) {
        TrustManager[] trustManagers = null;
        try {
            InputStream[] certificates = new InputStream[1];
            certificates[0] = context.getAssets().open("server.cer");
    ...
    public static KeyManager[] getKeyManagers(Context context) {
        ...
        try {
            InputStream bksFile = context.getAssets().open("android.bks");
